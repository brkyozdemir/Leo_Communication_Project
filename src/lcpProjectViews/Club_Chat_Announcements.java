 ...
 * @author Berkay
 */
public class Club_Chat_Announcements extends javax.swing.JFrame {
    ...
    public Club_Chat_Announcements() {
        initComponents();
        initialized();
        databaseUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Club_Chat_Announcements.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Club_Chat_Announcements().setVisible(true);
            }
        });
    }
